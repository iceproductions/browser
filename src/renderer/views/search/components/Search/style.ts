...
export const SearchIcon = styled.div`
  ...
  ${({ isFocused, theme, icon }: { isFocused: any; theme: ITheme; icon: any }) => css`
    ...
    background-size: ${isFocused ? (icon == store.details.favicon ? '18px' : '20px') : '18px'};
